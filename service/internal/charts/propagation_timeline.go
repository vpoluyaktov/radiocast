...
<div class="chart-container">
	<h3>Propagation Quality Timeline (24 Hours)</h3>
	%s
</div>
%s`, div, script)

	return ChartSnippet{ID: id, Title: "Propagation Quality Timeline (24 Hours)", Div: div, Script: script, HTML: completeHTML}, nil
}
